...
rem
rem CHANNEL, PLAYLIST and optional NEXT / VIDEO live in the sibling
...
def create_final_docs_settings_text(channel: str, playlist: str) -> str:
    return (
